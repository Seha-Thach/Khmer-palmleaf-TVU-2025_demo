...
The project uses the **Universal Viewer (UV)** to display digitized documents in **IIIF** format. **Annotations** are created from **PAGE-XML** and displayed as **text layers** via **IIIF Annotations**.
